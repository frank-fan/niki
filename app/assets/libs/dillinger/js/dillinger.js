$(function () {
    ...
    var editor
        ...
        , autoInterval
        , githubUser
        , paperImgPath = '/libs/dillinger/img/notebook_paper_200x200.gif'
        , profile =
        {
            theme: 'ace/theme/idle_fingers', showPaper: false, currentMd: '', autosave: {
            enabled: true, interval: 3000 // might be too aggressive; don't want to block UI for large saves.
        }, current_filename: 'Untitled Document', dropbox: {
            filepath: '/Dillinger/'
        }
        }
    ...
    var bgColors =
    {
        'chrome': '#bbbbbb', 'clouds': '#7AC9E3', 'clouds_midnight': '#5F9EA0', 'cobalt': '#4d586b', 'crimson_editor': '#ffffff', 'dawn': '#DADCAD', 'eclipse': '#6C7B8A', 'idle_fingers': '#DEB887', 'kr_theme': '#434343', 'merbivore': '#3E353E', 'merbivore_soft': '#565156', 'mono_industrial': '#C0C0C0', 'monokai': '#F5DEB3', 'pastel_on_dark': '#676565', 'solarized-dark': '#0E4B5A', 'solarized_light': '#dfcb96', 'textmate': '#fff', 'tomorrow': '#0e9211', 'tomorrow_night': '#333536', 'tomorrow_night_blue': '#3a4150', 'tomorrow_night_bright': '#3A3A3A', 'tomorrow_night_eighties': '#474646', 'twilight': '#534746', 'vibrant_ink': '#363636'
    }
    ...
    function initUi() {
        ...
        fetchTheme(/*profile.theme*/"ace/theme/merbivore", function () {
...
//    Notifier.showMessage(Notifier.messages.profileCleared, 1400)
    ...
    function fetchTheme(th, cb) {
        ...
        asyncLoad("/libs/dillinger/js/theme-" + name + ".js", function () {
    ...
    var Notifier = (function () {
        ...
        return {
            messages: {
                profileUpdated: "Profile updated", profileCleared: "Profile cleared", docSavedLocal: "Document saved locally", docSavedServer: "Document saved on our server", docSavedDropbox: "Document saved on dropbox", dropboxImportNeeded: "Please import a file from dropbox first."
            },
        ...
        function _extractMdFiles(repoName, treefiles) {
            ...
            treefiles.forEach(function (el) {
                ...
                if (_isMdFile(el.path)) {
                    ...
                    var item =
                    {
                        link: fullpath, path: el.path, sha: el.sha
                    }
