/* Rainbow v1.1.9 rainbowco.de | included languages: c, shell, java, d, coffeescript, generic, scheme, javascript, r, haskell, python, html, smalltalk, csharp, go, php, ruby, lua, css */
var k=!0;
...
b>c&&b<e[d][c])return k}return!1}function s(a,b){return'<span class="'+a.replace(/\./g," ")+(m?" "+m:"")+'">'+b+"</span>"}function t(a,b,c,h){var f=a.exec(c);if(f){++u;!b.name&&"string"==typeof b.matches[0]&&(b.name=b.matches[0],delete b.matches[0]);var l=f[0],i=f.index,v=f[0].length+i,g=function(){function f(){t(a,b,c,h)}u%100>0?f():setTimeout(f,0)};if(D(i,v))g();else{var n=w(b.matches),m=function(a,c,h){if(a>=c.length)h(l);else{var d=f[c[a]];if(d){var e=b.matches[c[a]],i=e.language,g=e.name&&e.matches?
e.matches:e,j=function(b,d,e){var i;i=0;var g;for(g=1;g<c[a];++g)f[g]&&(i=i+f[g].length);d=e?s(e,d):d;l=l.substr(0,i)+l.substr(i).replace(b,d);m(++a,c,h)};i?o(d,i,function(a){j(d,a)}):typeof e==="string"?j(d,d,e):x(d,g.length?g:[g],function(a){j(d,a,e.matches?e.name:0)})}else m(++a,c,h)}};m(0,n,function(a){b.name&&(a=s(b.name,a));if(!j[d]){j[d]={};e[d]={}}j[d][i]={replace:f[0],"with":a};e[d][i]=v;g()})}}else h()}function w(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b.sort(function(a,
b){return b-a})}function x(a,b,c){function h(b,l){l<b.length?t(b[l].pattern,b[l],a,function(){h(b,++l)}):E(a,function(a){delete j[d];delete e[d];--d;c(a)})}++d;h(b,0)}function E(a,b){function c(a,b,h,e){if(h<b.length){++y;var g=b[h],m=j[d][g],a=a.substr(0,g)+a.substr(g).replace(m.replace,m["with"]),g=function(){c(a,b,++h,e)};0<y%250?g():setTimeout(g,0)}else e(a)}var h=w(j[d]);c(a,h,0,b)}function o(a,b,c){var d=n[b]||[],f=n[z]||[],b=A[b]?d:d.concat(f);x(a.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&(?![\w\#]+;)/g,
"&amp;"),b,c)}function p(a,b,c){if(b<a.length){var d=a[b],f=C(d);return!(-1<(" "+d.className+" ").indexOf(" rainbow "))&&f?(f=f.toLowerCase(),d.className+=d.className?" rainbow":"rainbow",o(d.innerHTML,f,function(l){d.innerHTML=l;j={};e={};q&&q(d,f);setTimeout(function(){p(a,++b,c)},0)})):p(a,++b,c)}c&&c()}function B(a,b){var a=a&&"function"==typeof a.getElementsByTagName?a:document,c=a.getElementsByTagName("pre"),d=a.getElementsByTagName("code"),f,e=[];for(f=0;f<d.length;++f)e.push(d[f]);for(f=0;f<
c.length;++f)c[f].getElementsByTagName("code").length||e.push(c[f]);p(e,0,b)}var j={},e={},n={},A={},d=0,z=0,u=0,y=0,m,q;return{extend:function(a,b,c){1==arguments.length&&(b=a,a=z);A[a]=c;n[a]=b.concat(n[a]||[])},c:function(a){q=a},a:function(a){m=a},color:function(a,b,c){if("string"==typeof a)return o(a,b,c);if("function"==typeof a)return B(0,a);B(a,b)}}}();document.addEventListener?document.addEventListener("DOMContentLoaded",Rainbow.color,!1):window.attachEvent("onload",Rainbow.color);
Rainbow.onHighlight=Rainbow.c;Rainbow.addClass=Rainbow.a;Rainbow.extend("c",[{name:"meta.preprocessor",matches:{1:[{matches:{1:"keyword.define",2:"entity.name"},pattern:/(\w+)\s(\w+)\b/g},{name:"keyword.define",pattern:/endif/g},{name:"constant.numeric",pattern:/\d+/g},{matches:{1:"keyword.include",2:"string"},pattern:/(include)\s(.*?)$/g}]},pattern:/\#([\S\s]*?)$/gm},{name:"keyword",pattern:/\b(do|goto|typedef)\b/g},{name:"entity.label",pattern:/\w+:/g},{matches:{1:"storage.type",3:"storage.type",4:"entity.name.function"},pattern:/\b((un)?signed|const)? ?(void|char|short|int|long|float|double)\*? +((\w+)(?= ?\())?/g},
